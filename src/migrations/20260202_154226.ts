...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_pages_blocks_cta_links_link_appearance" ADD VALUE 'outline' BEFORE 'secondary';
  ALTER TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" ADD VALUE 'outline' BEFORE 'secondary';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_appearance" AS ENUM('secondary', 'default');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" AS ENUM('secondary', 'default');
