...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TYPE "public"."enum_pages_hero_links_link_appearance" ADD VALUE IF NOT EXISTS 'secondary' BEFORE 'outline';
...
ALTER TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" ADD VALUE IF NOT EXISTS 'primary' BEFORE 'outline';
  ...
  ALTER TYPE "public"."enum__pages_v_version_hero_links_link_appearance" ADD VALUE 'primary' BEFORE 'outline';
  ALTER TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" ADD VALUE 'secondary' BEFORE 'outline';
  ALTER TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" ADD VALUE 'primary' BEFORE 'outline';
